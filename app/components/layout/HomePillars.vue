...
const pillars = [
  {
    ...
    label: 'Kernbereich',
    title: 'Faktenchecks',
    desc: 'Der zentrale Einstieg: überprüfte Behauptungen, klare Urteile und Quellen, die man selbst nachlesen kann.',
    href: '/faktenchecks',
  ...
  },
  {
    ...
    label: 'Einordnung',
    title: 'Lagerfeuer',
    desc: 'Hintergrund, Kontext, Meinungen und längere Analysen für Leser, die hinter die einzelne Behauptung schauen wollen.',
    href: '/lagerfeuer',
    cta: 'Zum Lagerfeuer',
  },
  {
    ...
    desc: 'Die offene Materialbasis des Projekts: Quellen, Zitate und Spuren, aus denen die Recherchen entstehen.',
    href: '/quellen',
