...
await definePageData({
  ...
  description: 'Originalzitate aus Politik, Medien und öffentlichen Quellen, gesammelt mit Kontext, Quellenbezug und Einordnung für Faktenchecks und Recherchen.',
})
