...
<template>
  <div>
    ...
    <p>
      ...
      ein SSL-/TLS-Zertifikat gesichert ist, wird dies durch die Anzeige von HTTPS in der URL signalisiert. Dies dient
      als
    ...
    <p>
      ...
      Datentransfer in Drittländer hingewiesen wird), erfolgt dies stets im Einklang mit den gesetzlichen Vorgaben.
    </p>
    <p>
      Für Datenübermittlungen in die USA stützen wir uns vorrangig auf das Data Privacy Framework (DPF), welches durch
      ...
      EU-Kommission entsprechen und vertragliche Verpflichtungen zum Schutz Ihrer Daten festlegen.
    </p>
    <p>
    ...
    <p>
      Bei den einzelnen Diensteanbietern informieren wir Sie darüber, ob sie nach dem DPF zertifiziert sind und ob
    ...
    <p>
      ...
      zu Drittlandtransfers und geltenden Angemessenheitsbeschlüssen können Sie dem Informationsangebot der
      EU-Kommission
      entnehmen: <a
    ...
    <ul>
      ...
      <li>
        8 Jahre - Buchungsbelege, wie z.B. Rechnungen und Kostenbelege (§ 147 Abs. 1 Nr. 4 und 4a i.V.m. Abs. 3 Satz 1
    ...
    <p>
      Fristbeginn mit Ablauf des Jahres: Beginnt eine Frist nicht ausdrücklich zu einem bestimmten Datum und beträgt sie
      mindestens ein Jahr, so startet sie automatisch am Ende des Kalenderjahres, in dem das fristauslösende Ereignis
      eingetreten ist. Im Fall laufender Vertragsverhältnisse, in deren Rahmen Daten gespeichert werden, ist das
    ...
    <p>
      Wir weisen darauf hin, dass dabei Nutzerdaten außerhalb des Raumes der Europäischen Union verarbeitet werden
    ...
    <ul class="m-elements">
      ...
      <li>
        <strong>Facebook-Seiten: </strong>Profile innerhalb des sozialen Netzwerks Facebook - Der Verantwortliche ist
        gemeinsam mit Meta Platforms Ireland Limited für die Erhebung und Übermittlung von Daten der Besucher unserer
        Facebook-Seite („Fanpage") verantwortlich. Dazu gehören insbesondere Informationen über das Nutzerverhalten
        (z.B.
        angesehene oder interagierte Inhalte, durchgeführte Handlungen) sowie Geräteinformationen (z.B. IP-Adresse,
        Betriebssystem, Browsertyp, Spracheinstellungen, Cookie-Daten). Näheres hierzu findet sich in der
        ...
        Die gemeinsame Verantwortlichkeit beschränkt sich ausschließlich auf die Erhebung der Daten durch Meta Platforms
        Ireland Limited (EU). Für die weitere Verarbeitung, einschließlich einer möglichen Übermittlung an Meta
        Platforms
        Inc. in den USA, ist allein Meta Platforms Ireland Limited verantwortlich; <strong>Dienstanbieter:</strong> Meta
        Platforms Ireland Limited, Merrion Road, Dublin 4, D04 X2K5, Irland; <span
          class=""
        ><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong>
        <a
      ...
      <li>
        <strong>X: </strong>Soziales Netzwerk; <strong>Dienstanbieter:</strong> X Internet Unlimited Company, One
        Cumberland Place, Fenian Street, Dublin 2 D02 AX07, Irland; <span class=""><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Website:</strong>
        <a
          href="https://x.com"
          target="_blank"
      ...
      <li>
        <strong>YouTube: </strong>Soziales Netzwerk und Videoplattform; <strong>Dienstanbieter:</strong> Google Ireland
        Limited, Gordon House, Barrow Street, Dublin 4, Irland; <span class=""><strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO); </span><strong>Datenschutzerklärung:</strong>
        <a
    ...
    <p>
      <strong>Hinweise zu Rechtsgrundlagen:</strong> Sofern wir die Nutzer um ihre Einwilligung in den Einsatz der
    ...
    <ul class="glossary">
      <li>
        ...
        die
        Grundlage für jegliche formelle Interaktion zwischen Personen und Diensten, Einrichtungen oder Systemen, indem
        sie
      ...
      <li>
        ...
        auch
        Metadaten, die Informationen über den Inhalt selbst liefern, wie Tags, Beschreibungen, Autoreninformationen und
      ...
      <li>
        ...
        sowie
        Kommunikationsmittel wie soziale Medien-Handles und Instant-Messaging-Identifikatoren.
      </li>
      <li>
        ...
        Netzwerken
        und Chat-Verläufe, inklusive der beteiligten Personen, Zeitstempel und Übertragungswege. Verfahrensdaten
        beschreiben die Prozesse und Abläufe innerhalb von Systemen oder Organisationen, einschließlich
      ...
      <li>
        ...
        von
        Informationen, die aufzeigen, wie Nutzer Anwendungen nutzen, welche Funktionen sie bevorzugen, wie lange sie auf
        bestimmten Seiten verweilen und über welche Pfade sie durch eine Anwendung navigieren. Nutzungsdaten können auch
        die Häufigkeit der Nutzung, Zeitstempel von Aktivitäten, IP-Adressen, Geräteinformationen und Standortdaten
      ...
      <li>
        ...
        sich
        auf eine natürliche Person beziehen (je nach Art der Profilbildung können dazu unterschiedliche Informationen
        betreffend die Demographie, Verhalten und Interessen, wie z.B. die Interaktion mit Webseiten und deren Inhalten,
        etc.) zu analysieren, zu bewerten oder, um sie vorherzusagen (z.B. die Interessen an bestimmten Inhalten oder
        Produkten, das Klickverhalten auf einer Webseite oder den Aufenthaltsort). Zu Zwecken des Profilings werden
        häufig
      ...
      <li>
        ...
        eingesetzt,
        um wiederkehrende Besucher zu erkennen und so genauere Analysen zur Nutzung eines Onlineangebotes zu erhalten.
      </li>
      <li>
      ...
      <li>
        <strong>Zielgruppenbildung:</strong> Von Zielgruppenbildung (englisch "Custom Audiences") spricht man, wenn
        ...
        die Profile gebildet wurden, entsprechen. Zur Zwecken der Bildung von Custom Audiences und Lookalike Audiences
