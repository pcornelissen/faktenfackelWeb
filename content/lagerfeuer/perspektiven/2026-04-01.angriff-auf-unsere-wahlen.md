...
<Reference code="taz-desinformation-entwicklungspolitik">Eine CeMAS-Studie</Reference> zeigt, wie amerikanische Verschwörungserzählungen, etwa über USAID als "Deep State"-Zentrale, nahezu unverändert auf deutsche Institutionen übertragen werden und über Telegram-Netzwerke des rechtsextremen Spektrums verbreitet werden.
...
Dass ausgerechnet die AfD den lautesten Chor bei Betrugsvorwürfen anstimmt, verdient eine Randnotiz: <Reference code="correctiv-afd-niedersachsen-untreue-schledde">CORRECTIV berichtete über Ermittlungen der Staatsanwaltschaft gegen elf AfD-Personen in Niedersachsen wegen Untreue</Reference>. Strukturelle Regelverstöße innerhalb der Partei sind also dokumentiert, nur eben nicht dort, wo die Wahlbetrugserzählung sie verortet.
