...
description: "Nach der Landtagswahl in Baden-Württemberg verbreitete ein Netzwerk mit Spuren nach Vietnam Falschbehauptungen über Wahlbetrug. Wie das funktioniert."
...
Dass ausgerechnet die AfD den lautesten Chor bei Betrugsvorwürfen anstimmt, verdient eine Randnotiz: <SourceRef code="correctiv-afd-niedersachsen-untreue-schledde">CORRECTIV berichtete über Ermittlungen der Staatsanwaltschaft gegen elf AfD-Personen in Niedersachsen wegen Untreue</SourceRef>. Strukturelle Regelverstöße innerhalb der Partei sind also dokumentiert, nur eben nicht dort, wo die Wahlbetrugserzählung sie verortet.

## Update April 2026: KI-generierte Wahlbetrugs-Erzählungen

Die Welle reißt nicht ab. Im April 2026 dokumentiert <SourceRef code="correctiv-faktenforum-ki-tiktok-afd-klage-neuwahlen-erfunden">CORRECTIV.Faktenforum mehrere TikTok-Videos</SourceRef>, in denen mit KI-generierter Stimme behauptet wird, die :quelle-ref{name="afd"} habe vor dem :quelle-ref{name="bundesverfassungsgericht"} eine Klage gegen die Bundestagswahl 2025 gewonnen und damit Neuwahlen erzwungen. Beides ist frei erfunden: Eine entsprechende AfD-Klage existiert nicht, und alle bisher entschiedenen Wahlprüfungsbeschwerden zur Bundestagswahl 2025 hat das Gericht verworfen oder als unwirksam erklärt. Die Videos zeigen typische KI-Indizien (unnatürliche Lippenbewegungen, KI-Stimme, Hintergrund-Logikfehler), kombinieren sie aber mit einer realen offenen Wahlprüfungsbeschwerde des :quelle-ref{name="bsw"} zur Stimmauszählung. Diese Vermengung ist die neue Stufe: Statt frei erfundener Behauptungen werden reale Verfahren mit erfundenen Akteuren und Ergebnissen verknüpft, was die Falschbehauptung schwerer widerlegbar erscheinen lässt.
