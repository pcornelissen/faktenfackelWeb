...
description: "Deutschland hat zu wenig Nachwuchs für die Renten von morgen: heute tragen zwei Beitragszahler einen Rentner. Was die Zahlen zur Krise wirklich sagen."
...
Jetzt zahlen ca. 2 Arbeitnehmer schon für einen Rentner, es waren mal 7 Arbeitnehmer pro Rentner. Der Zuschuss zur Rentenkasse ist der größte Block im Bundeshaushalt. 2025 wird der Zuschuss zur Rentenkasse <SourceRef code="ifo-zuschuss-rentenversicherung">
ein Drittel der Steuereinnahmen</SourceRef> betragen.
...
Zur Illustration der Altersstruktur:

<BevoelkerungAltersstruktur></BevoelkerungAltersstruktur>

Man sieht gut, dass der Balken für die Altersgruppe 60+ mit Abstand der größte ist, während die nachrückenden Geburtsjahrgänge unter 20 deutlich kleiner ausfallen.
...
Die positiven Zuwächse kommen vor allem von Migranten, die im Schnitt eine höhere Geburtenrate pro Frau haben, aktuell liegt der Wert da bei 1,88 Kindern pro Frau. Das reicht nicht aus, ist aber wesentlich besser für die Altersstruktur als die Rate der "einheimischen" Frauen. Dazu kommt, dass Migranten oft im arbeitsfähigen Alter ins Land kommen und so die Zahl der Beitragszahler erhöhen könnten, wenn man sie nicht [aktiv an der Arbeit hindern würde](/faktenchecks/gesellschaft/migration/migranten-arbeiten-nicht).

### Sterberate

Es ist nicht nur so, dass die Geburtenrate konstant niedrig ist, die Menschen werden durch die Verbesserungen in der Medizin <SourceRef code="destatis-lebenserwartung-2025">auch immer älter</SourceRef>. Das ist grundsätzlich eine gute Sache, aber es verschärft das Problem der Alterspyramide zusätzlich.

Als die Babyboomer geboren wurden, lag die Lebenserwartung bei ca. 63 Jahren, jetzt ist die Lebenserwartung im Schnitt bei 79 Jahren, wobei Frauen ca. 6–7 Jahre älter werden. Die Tendenz ist <SourceRef code="destatis-zahl-ältere-menschen-2025">weiter steigend</SourceRef>.

Das Renteneintrittsalter ist nicht in gleichem Maße gestiegen. Das liegt aber nicht nur an Klientelpolitik, denn auch wenn Menschen älter werden, lassen sich viele Arbeiten nicht mehr sinnvoll ausüben ab einem gewissen Alter. Daher ist eine <SourceRef code="bpb-diskussion-erhöhung-renteneintrittsalter">Anhebung</SourceRef> des Renteneintrittsalters <SourceRef code="igmetall-renteneintrittsalter-2025">nicht global sinnvoll</SourceRef>.

### Beitragszahler pro Rentner

Wie eingangs bereits geschrieben, haben wir aktuell ca. 2 Arbeitnehmer pro Rentner. Das war in der Vergangenheit anders. <SourceRef code="maurice-hoefgen-soziologe-ursache-rentenproblem">Maurice Höfgen beleuchtet die strukturellen Ursachen</SourceRef> im Gespräch mit einem Soziologen.
...
Bei all diesen Zahlen entsteht leicht der Eindruck, allein die sinkende Zahl der Beitragszahler treibe das System in die Krise. Das greift zu kurz. Denn wie viel ein Arbeitnehmer erwirtschaftet, ist nicht gleich geblieben, sondern stark gestiegen. Die Wirtschaftsleistung pro Kopf liegt heute bei etwa dem 2,4-fachen des Wertes von 1970. Rein rechnerisch könnten also weniger Beschäftigte trotzdem genug erarbeiten, um mehr Rentner mitzutragen, weil jeder Einzelne deutlich produktiver geworden ist.

Das Problem ist, dass dieser Produktivitätsgewinn kaum bei den Löhnen und noch weniger bei den Renten ankommt. <SourceRef code="maurice-hoefgen-rentner-kinder-ungleichheit">Maurice Höfgen und Michael Paetz zeigen</SourceRef>, dass Wirtschaftsleistung, Löhne und Standardrente bis in die späten 1980er Jahre fast im Gleichschritt liefen und sich danach immer weiter auseinanderentwickelten:

<img src="/files/lagerfeuer/rentensystem-bip-loehne-standardrente.webp" alt="Liniendiagramm: BIP pro Kopf, Durchschnittsbruttolöhne und Standardrente in Deutschland ab 1970, indexiert auf 100. Das BIP pro Kopf steigt auf etwa 240, die Löhne auf rund 200, die Standardrente nur auf etwa 150." style="max-width: 100%; height: auto"><br/>
*Grafik: [Maurice Höfgen & Michael Paetz, geldfürdiewelt.de](https://www.geldfuerdiewelt.de/p/zu-viele-rentner-zu-wenig-kinder)*

Während die Wirtschaftsleistung pro Kopf auf das 2,4-fache kletterte, erreichten die Bruttolöhne nur etwa das Doppelte und die Standardrente nur rund das Eineinhalbfache. Ein wachsender Teil der erwirtschafteten Werte fließt also in Gewinne und Vermögen statt in Löhne und Renten. Weil die gesetzliche Rente überwiegend aus Löhnen finanziert wird, fehlt dem System genau dieses Geld.

Das entkräftet die demografische Schieflage aus den Abschnitten oben nicht, beide Effekte wirken zusammen. Aber es verschiebt den Blick: Ein Teil der Lücke ließe sich schließen, wenn die gestiegene Produktivität gerechter verteilt würde, also ein größerer Anteil bei Löhnen und Renten landet statt bei den Kapitaleinkommen.
...
Es gab die Forderung, dass Beamte auch in die Rentenkassen einzahlen sollten, um die Lasten gerechter zu verteilen. Das ist aber finanziell nicht sinnvoll, denn die Beamten müssten auch ihre Pensionen aus der Rentenkasse bekommen, was die Rentenkasse zusätzlich belasten würde. Dazu kommt, dass Beamte im Schnitt älter werden als abhängige Beschäftigte. Das würde also bedeuten, dass durch die Beamten das Rentensystem einfach <SourceRef code="iw-koeln-bas-rente-beamte">nur mehr belastet werden würde</SourceRef>. Ja, die Beamten kriegen ohnehin irgendwann ihre Pension, aber durch den Wechsel auf die Rentenkasse würden sich jetzt Kosten in Milliardenhöhe ergeben, die das System zum jetzigen Zeitpunkt zusätzlich stark belasten würden.

Es gibt auch Vorschläge, ein System, wie in <SourceRef code="focus-türk-rente-beamte">Österreich einzuführen</SourceRef>, wo Beamte in die Rentenkasse einzahlen, aber im Gegenzug eine niedrigere Pension bekommen. Das würde aber nur kurzfristig helfen, denn das Grundproblem der Alterspyramide bleibt bestehen. Dazu ist fraglich, ob es rechtlich aktuell so einfach möglich ist, da den Beamten nicht einfach hohe neue Kosten "aufgebürdet" werden können, da es faktisch eine Gehaltskürzung wäre.

#### Selbständige

Viele Selbständige zahlen nicht in die Rentenkasse ein (<SourceRef code="bmas-wie-viele-sind-rentenversichert-2025">Nur ca 0,3 Mio., im Vergleich zu 3 Mio. ohne Renteneinzahlung</SourceRef>), weil sie es sich nicht leisten können oder wollen. Das führt dazu, dass ein großer Teil der arbeitenden Bevölkerung, der <SourceRef code="bpb-einkommen-selbststaendiger">stellenweise nicht unerheblich gut verdient</SourceRef>, nicht in die Rentenkasse einzahlt, was das System zusätzlich belastet.
...
Man sieht, dass durch Zuwanderung die ungünstige Altersverteilung leicht ausgeglichen wird. Der ausländische Anteil ist genau in den erwerbsfähigen Altersgruppen 21-49 überproportional hoch, während er in der 60+-Gruppe (wo der deutsche Überhang am größten ist) sehr klein ist. Für eine gesunde Altersverteilung wäre mindestens die doppelte Menge an Migranten nötig, die bei der Eingliederung in die Gesellschaft und das Arbeitsleben aktiv unterstützt werden müssten, um die freien und bald frei werdenden Arbeitsplätze zu besetzen. Diese Arbeitsplätze sind jetzt schon in allen Bereichen und Qualifizierungsstufen und mit der Verrentnungswelle wird das ein echtes Problem für die Firmen, wenn keine Strategien vorbereitet werden, wie diese Lücken geschlossen werden können.
...
Hinzu kommt die Verteilungsfrage. Die Wirtschaft erwirtschaftet pro Kopf heute deutlich mehr als früher, doch dieser Zuwachs landet immer seltener bei Löhnen und Renten. Eine gerechtere Verteilung der gestiegenen Produktivität auf Gehälter und Renten würde das System nicht retten, aber spürbar entlasten.
...
- **3. Juni 2026:** Abschnitt "Produktivität und Verteilung" ergänzt, der die seit 1970 stark gestiegene Wirtschaftsleistung pro Kopf der schwächeren Entwicklung von Löhnen und Renten gegenüberstellt (Grafik und Einordnung nach Maurice Höfgen und Michael Paetz).
