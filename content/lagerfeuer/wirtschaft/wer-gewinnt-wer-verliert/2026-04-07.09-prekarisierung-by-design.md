...
<SourceRef code="wsi-tarifloehne-reallohne-2024">Erst 2024 stiegen Tariflöhne nominal um 5,5 Prozent und damit erstmals wieder deutlich stärker als die Inflation.</SourceRef> Das war der erste echte Reallohnanstieg nach Jahren der Stagnation und der Hochinflationsphase 2021 bis 2023. Die kumulierten Reallohnverluste dieser Inflationsjahre sind noch nicht vollständig aufgeholt.

<SourceRef code="wsi-verteilungsbericht-2025-ungleichheit">Der WSI-Verteilungsbericht 2025 zeigt: Die Einkommensungleichheit in Deutschland hat seit 2010 zugenommen.</SourceRef> Das ist kein Zufall. Es ist zumindest auch die Folge eines Arbeitsmarkts, der Niedriglohnarbeit strukturell begünstigt.
...
Dass dieses Muster kein deutsches Alleinstellungsmerkmal ist, zeigt der Blick über den Atlantik. In den USA sind die Unternehmensgewinne nach Steuern seit 1988 von 266 auf über 3.200 Milliarden Dollar gestiegen, während die Steuereinnahmen aus Unternehmensgewinnen kaum mitgewachsen sind. <SourceRef code="robert-reich-trickle-down-fred-chart">Robert Reich bringt es auf den Punkt: "Nothing trickled down."</SourceRef>

<TrickleDownChart />

<SourceRef code="hoefgen-nius-rente-spitzensteuersatz-debunk">Maurice Höfgen zeigt am deutschen Beispiel, warum die Erklärung über den Spitzensteuersatz zu kurz greift</SourceRef>: Nicht die Steuerlast auf Arbeit ist das Problem, sondern die Entkopplung von Löhnen und Wirtschaftsleistung, verstärkt durch die politisch gewollte Absenkung des Rentenniveaus von 53 auf 48 Prozent.
...
<SourceRef code="spielmanns-mindestlohn-armutsgrenze-2026">Der Mindestlohn in Deutschland ist noch immer nicht armutsfest</SourceRef>. Das heißt: Vollzeitarbeit zum Mindestlohn schützt nicht vor Altersarmut. Die Rentenbeiträge, die auf diesen Löhnen basieren, sind zu niedrig für eine armutsfeste Rente nach 40 Jahren Arbeit. Das ist eine eingebaute Zeitbombe: Millionen Menschen, die heute im Niedriglohnbereich arbeiten, werden in zwanzig Jahren Grundsicherung im Alter beziehen, finanziert durch die Allgemeinheit. Das Unternehmen, das heute von ihren niedrigen Löhnen profitiert, zahlt dafür nicht.

<SourceRef code="spielmanns-lohn-preis-mythos-2026">Die Lohn-Preis-Spirale, mit der Löhne oft klein gehalten werden, ist laut Ökonomen ein Mythos.</SourceRef> Der Einwand, höhere Löhne führten zu Inflation, ist theoretisch angreifbar und empirisch schwach belegt. Der weitaus größere Inflationstreiber der letzten Jahrzehnte war Energiepreisentwicklung und Lieferkettenkosten, nicht Lohnsteigerungen.

<SourceRef code="volksverpetzer-afd-keine-arbeiterpartei">Die AfD, die sich als Partei der Arbeiter positioniert, würde mit ihrem Programm die Lage der Niedriglohnbeschäftigten strukturell verschlechtern</SourceRef>, durch Mindestlohnsenkung, Gewerkschaftsschwächung und Sozialleistungsabbau. Das ist das Paradox: Die Partei, die von der Wut auf die Verhältnisse profitiert, plant deren Verschlimmerung.
