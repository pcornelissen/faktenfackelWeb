...
Wie weit Anspruch und politische Praxis auseinanderklaffen, zeigt sich an der aktuellen Wirtschaftspolitik selbst. <SourceRef code="hoefgen-reiche-drei-irrtuemer">Maurice Höfgen analysiert die Pressekonferenz von Bundeswirtschaftsministerin Katharina Reiche zur Frühjahrsprojektion 2026</SourceRef> und zerlegt drei zentrale Aussagen: Reiche stützt das geschätzte Wachstum von 0,5 Prozent fast ausschließlich auf Sondervermögen und Verteidigungsbereichsausnahme, lehnt aber zusätzliche fiskalische Impulse für die Binnenwirtschaft ab. Ohne diese Impulse läge das BIP nach Höfgens Rechnung um etwa zweieinhalb Prozent niedriger, ein Befund, den auch das [DIW Berlin in einer eigenen Modellrechnung](https://www.diw.de/de/diw_01.c.939521.de/publikationen/diw_aktuell/2025_0103/ausgaben_aus_dem_sondervermoegen_entscheiden_ueber_das_wachstum.html) bestätigt. Zugleich verteidigt sie die Pendlerpauschale, die laut DIW vor allem Besserverdienende entlastet, und beschreibt den Staatshaushalt rhetorisch wie ein Sparschwein. Wer den Mechanismus, mit fiskalischen Impulsen den Abfluss aus dem Kreislauf auszugleichen, ablehnt, obwohl er funktioniert, vergrößert das Leck eher, als es zu schließen.
