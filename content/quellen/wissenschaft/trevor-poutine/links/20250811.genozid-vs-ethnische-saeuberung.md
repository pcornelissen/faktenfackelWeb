...
type: reel
code: trevor-poutine-genozid-vs-etnische-saeuberung # <!-- LEKTOR: Tippfehler im Code-Feld: "etnische" statt "ethnische" — Code-Felder sind unique IDs, Korrektur nur nach Prüfung ob der Code bereits in referenceCodes/quoteCodes anderer Dateien verwendet wird -->
tags:
...
**Zur ethnischen Säuberung:** Poutines Kernaussage - ethnische Säuberung sei kein vom Völkerrecht definiertes eigenständiges Verbrechen - ist im Wesentlichen korrekt. Wie [ICRC und Humanitarian Law](https://casebook.icrc.org/a_to_z/glossary/ethnic-cleansing) bestätigen, existiert kein eigenständiger Tatbestand "ethnische Säuberung" in internationalen Abkommen. <!-- LEKTOR: Die ICRC-Casebook-Seite gibt keine explizite Aussage wieder, dass ethnische Säuberung kein eigenständiger Tatbestand ist - sie definiert nur den Begriff. Besser den guide-humanitarian-law.org-Link für diese spezifische Aussage verwenden oder Formulierung anpassen: "existiert in keinem internationalen Abkommen ein eigenständiger Straftatbestand" --> Allerdings ist die Darstellung, ethnische Säuberung sei schlicht "not a crime according to the international community", irreführend vereinfacht: Handlungen, die eine ethnische Säuberung ausmachen (Deportation, Vertreibung), können nach den Statuten des IStGH und des Jugoslawienstribunals (ICTY) als [Verbrechen gegen die Menschlichkeit oder als Kriegsverbrechen](https://guide-humanitarian-law.org/content/article/3/ethnic-cleansing/) verfolgt werden. Zudem ist ethnische Säuberung explizit eine der vier Massengreuelverbrechen, die die R2P-Doktrin adressiert.
