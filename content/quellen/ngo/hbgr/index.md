...
Das HBgR ist kein eingetragener Verein, sondern ein loses Bündnis, das kollektiv Entscheidungen trifft. Zu seinen Aktivitäten zählen die Organisation von Gegendemonstrationen zu Neonazi-Aufmärschen, das jährliche Ohlsdorfer Friedensfest (seit 2009) und die gemeinsam mit der VVN-BdA Hamburg betriebene Dokumentationsplattform [AfD-Watch Hamburg](https://afd-watch-hamburg.org/) (seit 2019). Das Spendenkonto wird von der [VVN-BdA Hamburg](https://hamburg.vvn-bda.de/) verwaltet, die als Trägerorganisation fungiert.
...
- Website: [hbgr.org](https://www.hbgr.org/)
- AfD-Watch Hamburg: [afd-watch-hamburg.org](https://afd-watch-hamburg.org/)
- VVN-BdA Hamburg über HBgR: [hamburg.vvn-bda.de](https://hamburg.vvn-bda.de/hamburger-buendnis-gegen-rechts/)
- Twitter/X: [@H_B_g_R_Info](https://twitter.com/H_B_g_R_Info)
