...
name: Martin Sellner
description: Österreichischer Rechtsextremist, Mitbegründer der Identitären Bewegung Österreich
tags:
  - Rechtsextremismus
  - Österreich
  - Identitäre
...
- [Wikipedia: Martin Sellner](https://de.wikipedia.org/wiki/Martin_Sellner)
- [Wikipedia: Identitäre Bewegung](https://de.wikipedia.org/wiki/Identit%C3%A4re_Bewegung)

## Faktenfackel Bewertung

Sellner ist keine Quelle für Sachaussagen. Er ist ein politischer Akteur aus dem rechtsextremen Lager, dessen Rhetorik und Konzepte dokumentiert und analysiert werden können, aber nicht als Faktengrundlage dienen dürfen.

### Fazit

Ausschließlich als Primärquelle verwenden, um zu belegen, was er selbst sagt oder fordert. Niemals als sachliche Autorität zitieren.
