...
Laut dem <SourceRef code="verfassungsschutz-linksextremismus-zahlen-2024">Verfassungsschutz</SourceRef> gab es 2024
etwa 11.200 linksextremistische Personen, darunter 8.400 <SourceRef code="verfassungsschutz-glossar-autonome">Autonome</SourceRef>, die als besonders gewaltbereit gelten. Der Verfassungsschutz ordnet diesem Spektrum rund 5.000
...
Zum Vergleich: Im <SourceRef code="verfassungsschutz-rechtsextremismus-zahlen-2024">rechtsextremistischen Spektrum</SourceRef>
...
Auch in <SourceRef code="statista-artikel-politische-lager-straftaten">anderen Statistiken</SourceRef> zeigt sich ein ähnliches Bild.
...
Zusätzliche Aufnahmen aus Gießen zeigen zahlreiche friedliche Szenen der Demonstration. Dazu gehören etwa die auf Instagram verbreiteten Bilder zu <SourceRef code="insta-till-hentschel-gießen-demo-friedlich">"Gießen brennt"</SourceRef> sowie ein [Kurzclip von Mittelhessen](https://www.youtube.com/shorts/M37wRPKM_Bo).
...
Besonders viel Aufmerksamkeit erhielt ein Video von einer Situation an einer Brücke. Die Aufnahme wurde unter anderem von <SourceRef code="wikipedia-sina-reisch">Sina Reisch</SourceRef> verbreitet. Zusätzlich hat die <SourceRef code="hessenschau-gießen-2025">Hessenschau</SourceRef> die Sequenz und den damaligen Kenntnisstand zusammengefasst.
