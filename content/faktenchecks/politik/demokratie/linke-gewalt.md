...
Das Bundeskriminalamt erfasst linksextreme Straftaten im Rahmen der Politisch motivierten Kriminalität (PMK). Die Zahlen für 2024 zeigen einen deutlichen Anstieg: 5.857 Straftaten mit linksextremem Hintergrund wurden registriert, ein Plus von 37,9 Prozent gegenüber dem Vorjahr ([Quelle: BKA, PMK-Fallzahlen 2024](https://www.bka.de/DE/UnsereAufgaben/Deliktsbereiche/PMK/PMKZahlen2024/PMKZahlen2024_node.html)). Der Anstieg entfällt überwiegend auf Sachbeschädigungen (rund 3.140 Fälle, häufigster Delikttyp) sowie Propagandadelikte und Verstöße gegen das Versammlungsrecht. Bei den Gewalttaten ging die Zahl hingegen um 26,8 Prozent auf 532 Delikte zurück ([Quelle: Verfassungsschutz, Zahlen und Fakten Linksextremismus](https://www.verfassungsschutz.de/DE/themen/linksextremismus/zahlen-und-fakten/zahlen-und-fakten_node.html)). Mehr Straftaten, aber weniger Gewalt: Der Anstieg spiegelt also vor allem eine Zunahme niedrigschwelliger Delikte wider, nicht eine Eskalation der Gewalt.

Der Verfassungsschutz zählt für 2024 ein linksextremes Personenpotenzial von 38.000, davon 11.200 als gewaltorientiert eingestuft ([Quelle: Verfassungsschutzbericht 2024](https://www.verfassungsschutz.de/DE/verfassungsschutz/der-bericht/vsb-linksextremismus/2024-vsb-linksextremismus_artikel.html)).

Zum Vergleich: Im selben Zeitraum wurden 42.788 Straftaten im Bereich PMK-rechts registriert, darunter 1.488 Gewalttaten ([Quelle: BKA, PMK 2024](https://www.bka.de/DE/UnsereAufgaben/Deliktsbereiche/PMK/PMKZahlen2024/PMKZahlen2024.html)). Rechtsextreme Straftaten machten damit mehr als die Hälfte aller politisch motivierten Straftaten aus. Das rechtsextreme Personenpotenzial überschritt 2024 erstmals die 50.000er-Marke (50.250 Personen, davon 15.300 gewaltorientiert) ([Quelle: Verfassungsschutzbericht 2024](https://www.verfassungsschutz.de/DE/verfassungsschutz/der-bericht/vsb-rechtsextremismus/2024-vsb-rechtsextremismus_artikel.html)).

### Linksextremer Terror und Gewalt

Linksextreme Gewalt hat in Deutschland eine reale Geschichte:

**RAF (1970 bis 1998):** Die Rote Armee Fraktion war die schwerwiegendste linksextreme Terrorgruppe der deutschen Nachkriegsgeschichte. 34 Menschen fielen ihrem Terror zum Opfer, mehr als 200 wurden verletzt. Neben der RAF setzten die Bewegung 2.\u00A0Juni (1972 bis 1980) und die Revolutionären Zellen (1973 bis 1995) terroristische Mittel ein ([Quelle: bpb, Die Opfer der RAF](https://www.bpb.de/themen/linksextremismus/geschichte-der-raf/49305/die-opfer-der-raf/)). Die RAF löste sich 1998 selbst auf. Vergleichbare Strukturen existieren heute nicht mehr.

**G20-Gipfel Hamburg (Juli 2017):** Während der Proteste kam es zu schweren Ausschreitungen. Linksextremisten suchten Konfrontationen mit der Polizei, errichteten Barrikaden und verübten Brandanschläge. Hunderte Polizisten wurden verletzt, es entstanden Sachschäden in Millionenhöhe. Autos wurden angezündet, Geschäfte geplündert ([Quelle: bpb, G20 in Hamburg](https://www.bpb.de/system/files/dokument_pdf/Leseprobe_BpB_Mathaner_Teune_Eskalation.pdf)). Der Hamburger G20 gilt als eine der schwersten linksextremen Gewalteruptionen der jüngeren Geschichte.
...
**Brandanschläge und Sachbeschädigungen:** Fahrzeuge und Gebäude werden regelmäßig Ziel linksextremer Anschläge. Die Kampagne "Abschalten" ("Switch off"), Anfang 2023 gestartet, gilt dem Verfassungsschutz als derzeit bedeutendste militante Kampagne im Linksextremismus, die "Anti-Kapitalismus" mit klimapolitischen Themen verbindet und kritische Infrastruktur angreift ([Quelle: Verfassungsschutzbericht 2024](https://www.verfassungsschutz.de/DE/verfassungsschutz/der-bericht/vsb-linksextremismus/2024-vsb-linksextremismus_artikel.html)).

**Angriffe auf AfD-Vertreter:** Die Wahlerfolge der AfD wirken nach Einschätzung des BKA mobilisierend auf Teile der linken Szene. Konfrontationen mit der AfD trieben die Fallzahlen im Bereich PMK-links 2024 nach oben. 2023 war die AfD mit 86 Gewaltdelikten gegen Parteivertreter am stärksten betroffen, im ersten Halbjahr 2024 erneut mit 48 Fällen ([Quelle: Bundestag, Angriffe auf Parteirepräsentanten](https://www.bundestag.de/presse/hib/kurzmeldungen-988578)). Gewalt gegen Politiker ist unabhängig von der politischen Richtung inakzeptabel.
...
Die offiziellen Zahlen für 2024 im direkten Vergleich:

| | PMK-rechts | PMK-links | Faktor |
|---|---|---|---|
| Straftaten gesamt | 42.788 | 5.857 | 7,3x |
| Gewalttaten | 1.488 | 532 | 2,8x |
| Personenpotenzial (Verfassungsschutz) | 50.250 | 38.000 | 1,3x |
| davon gewaltorientiert | 15.300 | 11.200 | 1,4x |
| Todesopfer seit 1990 | mind. 219 | 4 | 55x |

Quellen: [BKA PMK 2024](https://www.bka.de/DE/UnsereAufgaben/Deliktsbereiche/PMK/PMKZahlen2024/PMKZahlen2024_node.html), [Verfassungsschutzbericht 2024](https://www.bmi.bund.de/SharedDocs/pressemitteilungen/DE/2025/06/vsb2024.html), [Amadeu Antonio Stiftung](https://www.amadeu-antonio-stiftung.de/rassismus/todesopfer-rechter-gewalt/)
...
Gleichzeitig zeigen die Daten: Eine Gleichsetzung von linker und rechter Gewalt ist durch die Fakten nicht gedeckt. Das gilt für die Zahl der Straftaten (Faktor 7), die Zahl der Gewalttaten (Faktor 3), die Zahl der Todesopfer (Faktor 55) und die Gewaltintensität. Der Verfassungsschutz selbst schätzt das Gefahrenpotenzial rechtsextremer Gewalt höher ein als das linksextremer Gewalt ([Quelle: bpb](https://www.bpb.de/themen/linksextremismus/dossier-linksextremismus/523927/links-und-rechtsextremistische-straftaten-im-vergleich/)).

Die "Beide Seiten sind gleich schlimm"-Rhetorik erfüllt in der politischen Debatte eine bestimmte Funktion: Sie wird regelmäßig eingesetzt, um von rechtsextremer Gewalt abzulenken oder sie zu relativieren. Die Bundeszentrale für politische Bildung warnt davor, Linksextremismus und Rechtsextremismus mechanisch gleichzusetzen, da sich die Bedrohungslagen qualitativ und quantitativ unterscheiden ([Quelle: bpb, Extremismus](https://www.bpb.de/themen/linksextremismus/dossier-linksextremismus/33591/extremismus-linksextremismus-rechtsextremismus/)).

## Fazit

Linksextreme Gewalt existiert, wird erfasst und strafrechtlich verfolgt. Sie zu verharmlosen wäre falsch. Wer aber behauptet, linke Gewalt sei "genauso schlimm" wie rechte Gewalt oder gar die größere Bedrohung, ignoriert die offiziellen Statistiken. In allen messbaren Kategorien (Straftaten, Gewalttaten, Todesopfer, Organisationsgrad, Gewaltintensität) liegt rechtsextreme Gewalt deutlich über linksextremer Gewalt. Die Gleichsetzung ist eine Relativierungsstrategie, keine faktenbasierte Analyse.
