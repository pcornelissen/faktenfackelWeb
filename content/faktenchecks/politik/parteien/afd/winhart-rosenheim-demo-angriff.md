...
::quote-block
---
name: Michael Maurer, AfD-Bürgermeisterkandidat aus Griesstätt
---
...
::quote-block
---
name: Journalistenwatch, 2. März 2026
src: https://journalistenwatch.com/2026/03/02/unsere-demokratie-im-einsatz-afd-buergermeisterkandidat-von-antifa-linksfaschisten-in-rosenheim-zusammengetreten-und-schwer-verletzt/
---
...
::quote-block
---
name: Volksverpetzer, 3. März 2026
src: https://www.volksverpetzer.de/aktuelles/rosenheim-afd-angriff-demonstranten/
---
...
Ein <SourceRef code="winhart-rosenheim-konfrontation">Video von Sinom Tiew auf Bluesky</SourceRef> dokumentiert den vollständigen Vorfall über rund zwei Minuten. Es zeigt klar die zeitliche Abfolge:
...
Die <SourceRef code="taz-rosenheim-afd-schwalbe">taz</SourceRef> beschreibt den Videobeweis entsprechend deutlich: Das
...
Die Staatsanwaltschaft prüft nun ihrerseits, ob gegen Maurer Ermittlungen **wegen falscher Verdächtigung und Vortäuschens einer Straftat** einzuleiten sind. Wie <SourceRef code="t-online-rosenheim-afd-kandidat">t-online berichtet</SourceRef>, könnte das mutmaßliche Opfer nach der Wahl selbst zum Verdächtigen werden.
...
<SourceRef code="volksverpetzer-rosenheim-afd-angriff">Medien bundesweit unkritisch übernahmen</SourceRef>. Besonders
...
Vergleichbare Muster sind kein Einzelfall: Auch bei einem <SourceRef code="moz-afd-gewalt-presse">AfD-nahen Treffen in
Sachsen-Anhalt</SourceRef> griff das Umfeld Journalisten an, während die Polizei untätig blieb. In einem weiteren
dokumentierten Fall <SourceRef code="der-dara-afd-linker-angriff-videobeweis">behauptete die AfD einen "linken
