...
claimAppearance: "https://afdbundestag.de/lauterbachs-impftragoedie-darf-nicht-vertuscht-werden/"
summary: "Die Behauptung kollabiert in jedem Element. Die mRNA-Impfstoffe BNT162b2 (BioNTech/Pfizer) und mRNA-1273 (Moderna) durchliefen randomisierte, placebokontrollierte Phase-III-Studien mit zusammen über 73.000 Teilnehmenden, wurden von der EMA per Conditional Marketing Authorization (CMA) zugelassen, freiwillig nach Aufklärung verabreicht und seit der Zulassung ohne Unterbrechung pharmakovigilanzlich überwacht. Ein 'Menschenversuch' im Sinne des Nürnberger Kodex ist Forschung ohne Zustimmung oder ohne ethische Standards. Beides trifft auf die Impfkampagne nicht zu."
keyEvidence:
  - "BNT162b2 Phase-III-Studie mit 43.448 Teilnehmenden, 95 % Wirksamkeit gegen symptomatische COVID-19-Erkrankung, publiziert in NEJM Dezember 2020 (Polack et al.)."
  - "mRNA-1273 Phase-III-Studie COVE mit 30.420 Teilnehmenden, 94,1 % Wirksamkeit, publiziert in NEJM Februar 2021 (Baden et al.)."
  - "EMA Conditional Marketing Authorization für Comirnaty am 21. Dezember 2020, für Spikevax am 6. Januar 2021. CMA ist seit 2006 ein etablierter regulärer Zulassungsweg, kein Notfall-Sonderrecht."
  - "Paul-Ehrlich-Institut veröffentlicht seit 27. Dezember 2020 fortlaufende öffentliche Sicherheitsberichte mit Verdachtsfallquoten und Signaldetektion."
  - "Keine allgemeine Impfpflicht in Deutschland; die einrichtungsbezogene Impfpflicht für Pflege und Gesundheitsbereich (Mar 2022 bis Dez 2022) war zeitlich und sektoral begrenzt."
primarySources:
  - label: "AfD-Bundestagsfraktion: Pressemitteilung 'Lauterbachs Impftragödie darf nicht vertuscht werden!' (20. März 2026, Original-Statement)"
    url: "https://afdbundestag.de/lauterbachs-impftragoedie-darf-nicht-vertuscht-werden/"
  - label: "Polack F. P. et al.: 'Safety and Efficacy of the BNT162b2 mRNA Covid-19 Vaccine' (NEJM, 31. Dezember 2020)"
    url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2034577"
  - label: "Baden L. R. et al.: 'Efficacy and Safety of the mRNA-1273 SARS-CoV-2 Vaccine' (NEJM, 4. Februar 2021)"
    url: "https://www.nejm.org/doi/full/10.1056/NEJMoa2035389"
  - label: "European Medicines Agency: 'EMA recommends first COVID-19 vaccine for authorisation in the EU' (21. Dezember 2020)"
    url: "https://www.ema.europa.eu/en/news/ema-recommends-first-covid-19-vaccine-authorisation-eu"
  - label: "European Medicines Agency: 'Conditional marketing authorisation' (Erläuterung des regulatorischen Pfads)"
    url: "https://www.ema.europa.eu/en/human-regulatory-overview/marketing-authorisation/conditional-marketing-authorisation"
  ...
  - label: "U.S. National Library of Medicine: 'Nuremberg Code' (Englischer Originaltext, 1947)"
    url: "https://www.cms.hhs.gov/Regulations-and-Guidance/Guidance/Transmittals/downloads/R37SOMA.pdf"
  - label: "Bundesministerium für Gesundheit: 'Beschluss des Bundestags zur Aufhebung der einrichtungsbezogenen Impfpflicht' (16. Dezember 2022)"
    url: "https://www.bundesgesundheitsministerium.de/themen/gesundheitswesen/impfpflicht-corona/begriffe-zur-impfpflicht.html"
tags:
  - AfD
  - Baum
  - COVID-19
...
Die Aussage transportiert vier Behauptungen:

1. Die Impfkampagne war ein "Menschenversuch".
2. Die Tests vor der Zulassung waren "unzureichend".
3. Die Zulassung erfolgte "in Rekordzeit".
4. Die Impfung wurde "an Milliarden von Menschen ausprobiert".

Die Pressemitteilung verlinkt keine Studien, keine Zulassungsdokumente und keine konkreten Schadenszahlen.

## Die Fakten

### "Menschenversuch" hat eine medizinrechtliche Definition, die hier nicht zutrifft

Der Begriff "Menschenversuch" ist nicht beliebig. Seit dem Nürnberger Kodex (1947) und der Helsinki-Deklaration des Weltärztebundes bezeichnet er Forschung am Menschen, die ohne dessen freiwillige Einwilligung, ohne ausreichende vorklinische Grundlage oder unter Verletzung medizin-ethischer Standards stattfindet. Der erste Punkt des [Nürnberger Kodex](https://www.cms.hhs.gov/Regulations-and-Guidance/Guidance/Transmittals/downloads/R37SOMA.pdf) lautet wörtlich: "The voluntary consent of the human subject is absolutely essential."
...
Comirnaty wurde 2022 in eine Standardzulassung überführt, nachdem die nachgereichten Daten die Voraussetzungen erfüllten. Die "Rekordzeit" ergab sich aus der parallelen Durchführung von Studien-Phasen (Rolling Review), nicht aus der Verkürzung von Sicherheitsstandards. Hersteller und Zulassungsbehörden haben dies in der pandemischen Notlage öffentlich kommuniziert.
...
Es gibt drei Punkte, die sich aus dem AfD-Statement nicht abstreiten lassen, die aber nicht das tragen, was die Pressemitteilung suggeriert:

1. Die Zulassung erfolgte tatsächlich schneller als bei klassischen Standardzulassungen. Das ist Folge der CMA-Verfahren und des Rolling Review, nicht der Senkung von Sicherheitsstandards.
2. Pharmakovigilanz hat strukturelle Grenzen (Spontanmeldebias, Latenz). Das gilt für jedes Arzneimittel und ist Forschungsstand, kein versteckter Skandal.
3. Es gab und gibt seltene, dokumentierte Nebenwirkungen (Sinusvenenthrombosen mit AstraZeneca, Myokarditis bei mRNA-Impfstoffen bei jüngeren Männern). Diese sind in regulären Sicherheitsberichten ausgewiesen.

Keiner dieser Punkte rechtfertigt das Wort "Menschenversuch".
